...
public class VerifyinganAlianDictionary_953 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new VerifyinganAlianDictionary_953().isAlienSortedII(words, "hlabcdefgijkmnopqrstuvwxyz"));

        words = new String[] {"word", "world", "row"};
        System.out.println(new VerifyinganAlianDictionary_953().isAlienSortedII(words, "worldabcefghijkmnpqstuvxyz"));
    ...
    private boolean bigger(String prev, String next, int[] orderArray) {
        int prevLength = prev.length(), nextLength = next.length();
