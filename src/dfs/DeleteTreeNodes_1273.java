...
public class DeleteTreeNodes_1273 {
     ...
     * Constraints:
     * 
     * 1 <= nodes <= 10^4 -10^5 <= value[i] <= 10^5 parent.length == nodes parent[0]
     * == -1 which indicates that 0 is the root.
     */
    ...
    public static void main(String[] args) {
        System.out.println(new DeleteTreeNodes_1273().myDeleteTreeNodes(7, new int[] { -1, 0, 0, 1, 2, 2, 2 },
